            ...
            @foreach ($leaderboards as $lead)
                <div class="card text-center">
                    <div class="card-body participant">
                        ...
                        <div class="info">
                            <h4 class="card-title">{{ $lead->nama }}</h4>
                            <p class="card-text">{{ $lead->daerah }}</p>
                        </div>
                        <span class="votes" style="color: #e53935;">{{ $lead->jml_vote }} <br> Votes</span>
                    </div>
                </div>
            @endforeach
        </div>
                ...
                @foreach ($candidates as $cand)
                    <div class="col-lg-3 col-md-6">
                        <div class="card mb-4" style="padding: 10px;">
                            <img src="{{$cand->image}}" class="card-img-top" alt="{{ $cand->nama }}">
                            <div class="card-body">
                                <h5 class="card-title">{{ $cand->nama }}</h5>
                                <p class="card-text">{{ $cand->daerah }}</p>
                                <p class="card-text">Jumlah Vote: {{ $cand->jml_vote }}</p>
                                <button class="detail-btn btn btn-light" data-candidate="{{ $cand->nama }}" data-daerah="{{ $cand->daerah }}">Detail</button> <br><br>
                                <button class="vote-btn btn btn-primary" data-id="{{ $cand->id }}" data-candidate="{{ $cand->nama }}" data-image="{{$cand->image}}" data-price="2500">Vote</button>
                            </div>
                        </div>
                    </div>
                @endforeach
